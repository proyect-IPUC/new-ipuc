...
class ServiciosControllerTest < ActionController::TestCase
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post :create, servicio: { dia_de_pago: @servicio.dia_de_pago, empresa: @servicio.empresa, valor: @servicio.valor }
    end
  ...
  test "should update servicio" do
    patch :update, id: @servicio, servicio: { dia_de_pago: @servicio.dia_de_pago, empresa: @servicio.empresa, valor: @servicio.valor }
    assert_redirected_to servicio_path(assigns(:servicio))
  end

...
class DirectivasControllerTest < ActionController::TestCase
  ...
  test "should create directiva" do
    assert_difference('Directiva.count') do
      post :create, directiva: { apellido: @directiva.apellido, cargo: @directiva.cargo, nombre: @directiva.nombre }
    end
  ...
  test "should update directiva" do
    patch :update, id: @directiva, directiva: { apellido: @directiva.apellido, cargo: @directiva.cargo, nombre: @directiva.nombre }
    assert_redirected_to directiva_path(assigns(:directiva))
  end
